  ...
  return (
    <div className="space-y-8">
      ...
      {pointsLoading ? (
        ...
        <div className="space-y-5 rounded-2xl border border-primary/10 bg-gradient-to-b from-[color-mix(in_srgb,var(--report-wash)_20%,var(--card))] to-card p-6 dark:from-primary/[0.05] dark:to-card">
...
function SummaryCard({
  ...
  return (
    <div className="flex flex-col justify-between gap-2 md:gap-3 rounded-xl border border-primary/10 bg-card/95 p-4 md:p-5 dark:bg-card/70">
    ...
    <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3">
      {badges.map((badge) => (
        <div
          key={badge.badgeId}
          className={cn(
            "rounded-2xl bg-card border border-border/60 px-4 py-4 flex flex-col items-center gap-0 text-center",
...
function PointsSummarySkeleton() {
  return (
    <div className="space-y-5 rounded-2xl border border-primary/10 bg-card p-6">
      <div className="space-y-1">
        ...
        <div key={si} className="space-y-3">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3">
            {Array.from({ length: count }).map((_, i) => (
              <div
                key={i}
                className="rounded-2xl bg-card border border-border/60 px-4 py-4 flex flex-col items-center gap-0"
              >
